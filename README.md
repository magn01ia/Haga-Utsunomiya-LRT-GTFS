...
作成当初は手入力で行ったいましたが、運航開始に伴って「見える化共通入力フォーマット」を使用しています。  
...
- 作成ツールの変更  
これまでは情報も少なかったこともありテキストエディタ等で作成していましたが、今後の更新も考慮して見える化標準フォーマットで作成することにしました。
- 停留所idの見直し  
停留所idの振り方を変更しました、見える化標準フォーマットのマクロに従い作成しています。  
